...
const concubu = FA[Math.floor(Math.floor(Math.random() * FA.length))];
    ...
    const userAgent = {
        chrome: `${concudai}/${version1}.0 (${version1}.${version1}; ${concubu}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/${version}.0.0.0 Safari/537.36`,
        safari: `${concudai}/${version1}.0 (${concubu}) Version/${version}.0 Safari/605.1.15`,
        brave: `${concudai}/${version1}.0 (${version1}.${version1}; ${concubu}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/${version}.0.0.0 Safari/537.36`,
        firefox: `${concudai}/${version1}.0 (${version}.0; ${concubu}) Gecko/20100101 Firefox/${version}.0`,
        mobile: `${concudai}/${version1}.0 (${version1}; ${concubu}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/${version}.0.0.0 Mobile Safari/537.36` ,
        opera: `${concudai}/${version1}.0 (${version1}.${version1}; ${concubu}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/${version}.0.0.0 Safari/537.36 OPR/${version}` ,
        operagx: `${concudai}/${version1}.0 (${version1}.${version1}; ${concubu}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/${version}.0.0.0 Safari/537.36 OPR/${version}`
    };
