...
const version = getRandomInt(129, 134);
...
var user_agent = `Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/${version}.0.0.0 Safari/537.36`;
...
const rateHeaders2 = [
{ "TTL-3": "1.5" },
{"From-Unknown-Botnet" : "thaiduong30112010"},
];
const rateHeaders3 = [
{ "A-IM": "Feed" },
{"dnt" : 1},
...
const hea = {
            ...
            ...Headers1,
             ...Headers2,
                        ...
                        const head = header;
                        const request = await client.request({ ...author, ...head ,hea}, {
                            weight: rada,
                            parent: 0,
                            exclusive: false});
