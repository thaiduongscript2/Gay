...
const concubu = FA[Math.floor(Math.floor(Math.random() * FA.length))];
        var user_agent = `${concudai}/${version1}.${version1} (${version1}.${version1}; ${concubu} ${version1}; ${concubu}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/${version}.0.0.0 Safari/537.36`;
