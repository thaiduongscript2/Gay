...
const version1 = getRandomInt(0, 99);
const version2 = getRandomInt(100, 999);
...
const concubu = FA[Math.floor(Math.floor(Math.random() * FA.length))];
        var user_agent = `${concudai}/${version1}.${version1}.${version1} (${concubu}; ${concubu} ${version1}; ${concubu}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/${version}.0.0.0 ${concubu}/${version2}.${version1}`;
